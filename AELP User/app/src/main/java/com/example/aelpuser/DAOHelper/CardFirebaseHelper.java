...
public class CardFirebaseHelper {
    ...
    public CommunityChest addCommunityChestCards (String cardTitle, String cardContent, String addNotes){
        String id = ccCardReference.push().getKey();
        CommunityChest communityChest = new CommunityChest(id, cardTitle, cardContent, addNotes, false, false, "");
    ...
    public Chance addChanceCards (String cardTitle, String cardContent, String addNotes){
        String id = chanceCardReference.push().getKey();
        Chance chance = new Chance(id, cardTitle, cardContent, addNotes, false, false, "");
